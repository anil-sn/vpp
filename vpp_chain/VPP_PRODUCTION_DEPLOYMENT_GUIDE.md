...
# Use the pre-generated AWS production configuration
cp config_aws_production_ready.json config.json
...
# Use the pre-generated GCP production configuration
cp config_gcp_production_ready.json config.json
